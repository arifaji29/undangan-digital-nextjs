  ...
  return (
    <div className="relative min-h-screen w-full bg-white">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center text-center min-h-screen text-stone-800 px-4 pt-20 pb-50">
        <div className="mb-40">
          <h2 className="text-2xl mb-5" style={{ fontFamily: 'SourgummyThin'}}>
            The Wedding Of
          </h2>
        ...
        <div className="mb-20">
          <p className="text-lg" style={{ fontFamily: 'SourgummyThin'}} >Kepada Yth. Bapak/Ibu/Saudara/i</p>
          <p className="text-3xl font-semibold mt-2 mb-1" style={{ fontFamily: 'SourgummyMed'}}>
            {guestName.replace(/%20/g, ' ')}
          </p>
          <p className="text-lg" style={{ fontFamily: 'SourgummyThin'}}>di Tempat</p>
        </div>
        ...
        >
          <div className="flex items-center justify-center gap-2 z-10 relative" >
            ...
            <span style={{ fontFamily: 'SourgummyReg'}}>{hasOpened ? 'Save the Date' : 'Buka Undangan'}</span>
          </div>
